...
module.exports = function (sequelize) {
  ...
  var MainRegion = sequelize.import(PATH + '/models/base/main-region');
  _.extend(MainRegion.options.instanceMethods, {
    ...
    addUrl: function (toDeleteTrace, province) {
      ...
      this.dataValues.url = models.MainRegion.getUrl(this.toJSON(), province);
    ...
    addFeaturedUrl: function (toDeleteTrace, province, type) {
      ...
      this.dataValues.url = models.MainRegion.getUrl(this.toJSON(), province)+trail;
    ...
    addImages: function (limit) {
      ...
      return models.MainRegion.getImages(this.id, 'region', limit).then(function (res) {
  ...
  _.extend(MainRegion.options.classMethods, {
    getUrl: function (region, province) {
      if (!(region.hasOwnProperty("web_id") && typeof province !== "undefined")) {
        return '';
      }

      return '/'+province+'-real-estate/'+region.web_id+'/';
    },
