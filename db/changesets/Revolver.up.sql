...
UPDATE `theredpin`.`main_city` SET `feature_property`='0', `feature_project`='0' WHERE `id`='697';
UPDATE `theredpin`.`main_city` SET `feature_property`='1', `feature_project`='1' WHERE `id`='1072';
UPDATE `theredpin`.`main_city` SET `feature_project`='2' WHERE `id`='1053';
UPDATE `theredpin`.`main_city` SET `feature_property`='2' WHERE `id`='787';
